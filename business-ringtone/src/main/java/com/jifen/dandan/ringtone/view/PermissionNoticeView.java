...
public class PermissionNoticeView extends FrameLayout implements IFloatView{
...
//    private ImageView iv_zoom_btn;
    ...
    private float mRatio = 0.78f;//窗口高/宽比
    ...
    public PermissionNoticeView(Context mContext, FloatViewParams floatViewParams, WindowManager.LayoutParams wmParams, String permission) {
        super(mContext);
    ...
    private void initView() {
        Log.d("PermissionNoticeView","initview");
        mContext = getContext();
        mWindowManager = SystemUtils.getWindowManager(mContext);
        LayoutInflater inflater = LayoutInflater.from(getContext());
        View floatView = inflater.inflate(R.layout.view_permission_dialog, null);
...
//        videoViewWrap = (RelativeLayout) floatView.findViewById(R.id.videoViewWrap);
        mTvPermission = floatView.findViewById(R.id.tv_permission);
        tv_info = (TextView) floatView.findViewById(R.id.tv_info);
        tv_info.setText("找到"+permission+"并开启");
        mTvPermission.setText(permission);
        ...
        private void handleMoveEvent(MotionEvent event) {
            ...
            if (distance >= 2) {//控制刷新频率
                ...
                if (!isSdkGt23) {
                    ...
                    if (mWindowParams != null && mWindowParams.width != mMaxWidth) {
