 ...
 */
package com.beige.camera.common.view.loadding;
...
public class LoadingView2 extends View {
    ...
    private static final float MAX_PROGRESS_ARC = 600f;
    private static final float MIN_PROGRESS_ARC = 10f;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width = (int)( mRing.ringCenterRadius + mRing.strokeWidth ) * 2;
        int height = (int)( mRing.ringCenterRadius + mRing.strokeWidth) * 2;
