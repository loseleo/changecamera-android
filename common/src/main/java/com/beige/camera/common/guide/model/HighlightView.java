package com.beige.camera.common.guide.model;
...
import com.beige.camera.common.guide.util.ViewUtils;
...
public class HighlightView implements HighLight {
     ...
     */
    private int padding;
    private com.beige.camera.common.guide.model.HighlightOptions options;
    private RectF rectF;
    ...
    public void setOptions(com.beige.camera.common.guide.model.HighlightOptions options) {
