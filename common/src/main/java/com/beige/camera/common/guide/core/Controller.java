...
import com.beige.camera.common.guide.lifecycle.FragmentLifecycleAdapter;
import com.beige.camera.common.guide.lifecycle.ListenerFragment;
import com.beige.camera.common.guide.lifecycle.V4ListenerFragment;
import com.beige.camera.common.guide.listener.OnGuideChangedListener;
import com.beige.camera.common.guide.listener.OnPageChangedListener;
...
public class Controller {
    ...
    private com.beige.camera.common.guide.core.GuideLayout currentLayout;
    ...
    public void showPage(int position) {
        ...
        if (currentLayout != null) {
            currentLayout.setOnGuideLayoutDismissListener(new com.beige.camera.common.guide.core.GuideLayout.OnGuideLayoutDismissListener() {
                @Override
                public void onGuideLayoutDismiss(com.beige.camera.common.guide.core.GuideLayout guideLayout) {
                    showGuidePage();
                }
            });
