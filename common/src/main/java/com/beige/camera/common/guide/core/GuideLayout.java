package com.beige.camera.common.guide.core;
...
import com.beige.camera.common.guide.NewbieGuide;
import com.beige.camera.common.guide.listener.AnimationListenerAdapter;
import com.beige.camera.common.guide.listener.OnLayoutInflatedListener;
import com.beige.camera.common.guide.model.GuidePage;
import com.beige.camera.common.guide.model.HighLight;
import com.beige.camera.common.guide.model.HighlightOptions;
import com.beige.camera.common.guide.model.RelativeGuide;
...
public class GuideLayout extends FrameLayout {
    ...
    public GuideLayout(Context context, com.beige.camera.common.guide.model.GuidePage page, Controller controller) {
        super(context);
        init();
        setGuidePage(page);
...
//        //关闭当前view的硬件加速
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (Math.abs(upX - downX) < touchSlop && Math.abs(upY - downY) < touchSlop) {
                    List<com.beige.camera.common.guide.model.HighLight> highLights = guidePage.getHighLights();
                    for (com.beige.camera.common.guide.model.HighLight highLight : highLights) {
    ...
    private void notifyClickListener(com.beige.camera.common.guide.model.HighLight highLight) {
    ...
    private void addCustomToLayout(GuidePage guidePage) {
        ...
        List<com.beige.camera.common.guide.model.RelativeGuide> relativeGuides = guidePage.getRelativeGuides();
