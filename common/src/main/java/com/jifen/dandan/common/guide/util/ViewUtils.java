...
public class ViewUtils {
    ...
    public static Rect getLocationInView(View parent, View child) {
        ...
        while (tmp != decorView && tmp != parent) {
            com.jifen.dandan.common.guide.util.LogUtil.i("tmp class:" + tmp.getClass().getSimpleName());
            tmp.getHitRect(tmpRect);
            com.jifen.dandan.common.guide.util.LogUtil.i("tmp hit Rect:" + tmpRect);
            ...
            if (tmp.getParent() instanceof ScrollView) {
                ...
                com.jifen.dandan.common.guide.util.LogUtil.i("scrollY:" + scrollY);
                result.top -= scrollY;
            }
