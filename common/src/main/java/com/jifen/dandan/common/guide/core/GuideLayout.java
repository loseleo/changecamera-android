package com.jifen.dandan.common.guide.core;
...
import com.jifen.dandan.common.guide.NewbieGuide;
import com.jifen.dandan.common.guide.listener.AnimationListenerAdapter;
import com.jifen.dandan.common.guide.listener.OnLayoutInflatedListener;
import com.jifen.dandan.common.guide.model.GuidePage;
import com.jifen.dandan.common.guide.model.HighLight;
import com.jifen.dandan.common.guide.model.HighlightOptions;
import com.jifen.dandan.common.guide.model.RelativeGuide;
...
public class GuideLayout extends FrameLayout {
    ...
    public GuideLayout(Context context, com.jifen.dandan.common.guide.model.GuidePage page, Controller controller) {
        super(context);
        init();
        setGuidePage(page);
...
//        mPaint.setMaskFilter(new EmbossMaskFilter(1, BlurMaskFilter.Blur.INNER));
//        //关闭当前view的硬件加速
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (Math.abs(upX - downX) < touchSlop && Math.abs(upY - downY) < touchSlop) {
                    List<com.jifen.dandan.common.guide.model.HighLight> highLights = guidePage.getHighLights();
                    for (com.jifen.dandan.common.guide.model.HighLight highLight : highLights) {
    ...
    private void notifyClickListener(com.jifen.dandan.common.guide.model.HighLight highLight) {
    ...
    private void addCustomToLayout(GuidePage guidePage) {
        ...
        List<com.jifen.dandan.common.guide.model.RelativeGuide> relativeGuides = guidePage.getRelativeGuides();
