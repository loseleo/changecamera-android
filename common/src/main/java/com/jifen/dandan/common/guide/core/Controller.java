...
import com.jifen.dandan.common.guide.lifecycle.FragmentLifecycleAdapter;
import com.jifen.dandan.common.guide.lifecycle.ListenerFragment;
import com.jifen.dandan.common.guide.lifecycle.V4ListenerFragment;
import com.jifen.dandan.common.guide.listener.OnGuideChangedListener;
import com.jifen.dandan.common.guide.listener.OnPageChangedListener;
import com.jifen.dandan.common.guide.model.GuidePage;
import com.jifen.dandan.common.guide.util.LogUtil;
...
public class Controller {
    ...
    private com.jifen.dandan.common.guide.core.GuideLayout currentLayout;
    ...
    public void show() {
        ...
        mParentView.post(new Runnable() {
            @Override
            public void run() {
                if (ViewCompat.isAttachedToWindow(mParentView)) {
    ...
    public void showPage(int position) {
        ...
        if (currentLayout != null) {
            currentLayout.setOnGuideLayoutDismissListener(new com.jifen.dandan.common.guide.core.GuideLayout.OnGuideLayoutDismissListener() {
                @Override
                public void onGuideLayoutDismiss(com.jifen.dandan.common.guide.core.GuideLayout guideLayout) {
                    showGuidePage();
                }
            });
